...
- AWS re/Start Graduate: Programa intensivo de capacitação em nuvem e infraestrutura.
- CCNA (Módulo 1): Introdução a Redes e Configuração de Dispositivos Cisco.
- CyberOps Associate (Curso): Foco em operações de segurança e análise de ameaças.
